...
public class CsvConfig {
    ...
    @Bean
    CsvClientStatsVisitor csvVisitor(CsvWriter csvWriter, Day day) throws IOException {
        return new CsvClientStatsVisitor(csvWriter,day);
    }

    @Bean
    CommandLineRunner runner(CsvClientStatsVisitor csvVisitor)
    {
        return args -> {

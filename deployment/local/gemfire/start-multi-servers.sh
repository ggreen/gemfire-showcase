...
$GEMFIRE_HOME/bin/gfsh -e "start locator --name=locator1 --port=10334 --max-heap=250m --J=-Djava.net.preferIPv4Stack=false --initial-heap=250m --J=-Dgemfire.prometheus.metrics.emission=Default --J=-Dgemfire.prometheus.metrics.port=7777 --J=-Dgemfire.prometheus.metrics.host=localhost --J=-Dgemfire.prometheus.metrics.interval=15s --bind-address=127.0.0.1"

curl http://localhost:7777/metrics
$GEMFIRE_HOME/bin/gfsh -e "connect" -e "configure pdx --read-serialized=true --disk-store"
$GEMFIRE_HOME/bin/gfsh -e "start server --name=server1 --J=-Djava.net.preferIPv4Stack=false --max-heap=500m --initial-heap=500m --locators=localhost[10334] --server-port=1880 --J=-Dgemfire.prometheus.metrics.emission=Default --J=-Dgemfire.prometheus.metrics.port=7778 --J=-Dgemfire.prometheus.metrics.host=localhost --J=-Dgemfire.prometheus.metrics.interval=15s --bind-address=127.0.0.1  --http-service-port=8590" &
$GEMFIRE_HOME/bin/gfsh -e "start server --name=server2 --J=-Djava.net.preferIPv4Stack=false --max-heap=500m --initial-heap=500m --locators=localhost[10334] --server-port=1881 --J=-Dgemfire.prometheus.metrics.emission=Default --J=-Dgemfire.prometheus.metrics.port=7798 --J=-Dgemfire.prometheus.metrics.host=localhost --J=-Dgemfire.prometheus.metrics.interval=15s --bind-address=127.0.0.1  --http-service-port=8591"
$GEMFIRE_HOME/bin/gfsh -e "start server --name=server3 --J=-Djava.net.preferIPv4Stack=false --max-heap=500m --initial-heap=500m --locators=localhost[10334] --server-port=1882 --J=-Dgemfire.prometheus.metrics.emission=Default --J=-Dgemfire.prometheus.metrics.port=7799 --J=-Dgemfire.prometheus.metrics.host=localhost --J=-Dgemfire.prometheus.metrics.interval=15s --bind-address=127.0.0.1  --http-service-port=8592"

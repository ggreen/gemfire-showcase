...
$GEMFIRE_HOME/bin/gfsh -e "start locator --name=gclocator1 --port=10334   --J=-XX:-UseZGC  --J=-XX:+UseG1GC --J=-XX:G1MaxNewSizePercent=40 --J=-Xlog:gc=info:file=gc.log   --J=-Dgemfire.prometheus.metrics.emission=Default --J=-Dgemfire.prometheus.metrics.port=7777 --J=-Dgemfire.prometheus.metrics.host=localhost --J=-Dgemfire.prometheus.metrics.interval=15s --bind-address=127.0.0.1 --J=-Dgemfire.statistic-archive-file=locator.gfs  --J=-XX:+AlwaysPreTouch"

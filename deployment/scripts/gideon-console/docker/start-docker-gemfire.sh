...
docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]" -e "create gateway-receiver"


docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]"  -e  "create gateway-sender --id=Account_Sender_to_1 --parallel=true  --remote-distributed-system-id=1 --enable-persistence=true --enable-batch-conflation=true"

docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]" -e "create gateway-sender --id=test_to_1 --parallel=true  --remote-distributed-system-id=1 --enable-persistence=true --enable-batch-conflation=true"


docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]" -e "create region --name=Account --type=PARTITION --gateway-sender-id=Account_Sender_to_1"

docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]" -e "create region --name=health2 --type=PARTITION"



docker exec -it gf2-gl-locator gfsh -e "connect --jmx-manager=gf2-gl-locator[1098]" -e "create region --name=test --type=PARTITION --gateway-sender-id=test_to_1"

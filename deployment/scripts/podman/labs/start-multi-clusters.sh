...
podman exec -it gf2-locator gfsh -e "connect --locator=gf2-locator[10002]"  -e  "create gateway-sender --id=Account_Sender_to_1 --parallel=true  --remote-distributed-system-id=1 --enable-persistence=true --enable-batch-conflation=true"

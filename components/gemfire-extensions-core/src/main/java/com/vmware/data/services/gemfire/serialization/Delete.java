...
public class Delete
{
	...
	public Delete(JsonDocumentFactory factory) {
		this.factory = factory;
		this.toJsonFromNonPdxConverter = new ToJsonFromNonPdxObject();
	}

	public static Delete createPdx() {
		return new Delete(ClientCacheFactory.getAnyInstance().getJsonDocumentFactory(StorageFormat.BSON));
	}
	...
	public String addTypeToJson(String json, String type)
	{
		...
		StringBuilder prefix = new StringBuilder().append("{\"")
				.append(Delete.JSON_TYPE_ATTRIBUTE)
				.append("\":\"")
				.append(type).append("\"");
